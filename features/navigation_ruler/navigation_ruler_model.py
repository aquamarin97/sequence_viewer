...
class NavigationRulerModel:
    ...
    def compute_tick_layout(self, pixel_width: int, target_px: int = 60) -> Optional[NavigationTickLayout]:
    ...
    @staticmethod
    def _nice_tick_step(max_nt, pixel_width, target_px=60) -> int:
